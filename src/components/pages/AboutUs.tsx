      ...
      <div className="px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
          ...
          <ul className="list-disc list-inside mb-4 text-gray-700">
            ...
            <li>
              Private, your files are processed securely and expire
              automatically.
            </li>
            <li>Simple, no clutter, just the tools you need.</li>
          </ul>
          <p className="mb-4 text-gray-700">
            Whether you're compressing images, tuning them for the web,
            converting photos to PDF, or splitting and merging documents,
            FastFileTools helps you get it done quickly without sacrificing
            quality.
          </p>
